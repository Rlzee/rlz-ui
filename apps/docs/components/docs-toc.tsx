...
export function DocsTableOfContents({ toc, className }: Props) {
  ...
  return (
    <div
      className={cn(
        "z-10 flex flex-col gap-1 ps-6 pe-4 text-sm pt-6 lg:pt-8",
        className
      )}
    >
      <p className="flex h-8 items-center font-medium text-xs">On This Page</p>
